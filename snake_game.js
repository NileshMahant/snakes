...
function findWasmBinary() {
    return locateFile('snake_game.wasm');
}
...
var ASM_CONSTS = {
  93704: () => { if (document.fullscreenElement) return 1; },  
 93750: () => { return Module.canvas.width; },  
 93782: () => { return parseInt(Module.canvas.style.width); },  
 93830: () => { document.exitFullscreen(); },  
 93857: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93930: () => { if (document.fullscreenElement) return 1; },  
 93976: () => { return Module.canvas.width; },  
 94008: () => { return screen.width; },  
 94033: () => { document.exitFullscreen(); },  
 94060: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94193: () => { return window.innerWidth; },  
 94219: () => { return window.innerHeight; },  
 ...
 94372: () => { if (document.fullscreenElement) return 1; },  
 94418: () => { return Module.canvas.width; },  
 94450: () => { return screen.width; },  
 94475: () => { return window.innerWidth; },  
 94501: () => { return window.innerHeight; },  
 94528: () => { if (document.fullscreenElement) return 1; },  
 94574: () => { return Module.canvas.width; },  
 94606: () => { return screen.width; },  
 94631: () => { document.exitFullscreen(); },  
 94658: () => { if (document.fullscreenElement) return 1; },  
 94704: () => { return Module.canvas.width; },  
 94736: () => { return parseInt(Module.canvas.style.width); },  
 94784: () => { document.exitFullscreen(); },  
 94811: ($0) => { Module.canvas.style.opacity = $0; },  
 94849: () => { return screen.width; },  
 94874: () => { return screen.height; },  
 94900: () => { return window.screenX; },  
 94927: () => { return window.screenY; },  
 94954: () => { return window.devicePixelRatio; },  
 94990: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95043: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95094: () => { Module.canvas.style.cursor = 'none'; },  
 95131: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95387: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
